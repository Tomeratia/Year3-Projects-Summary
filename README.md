...
The KITTI dataset illustrates this imbalance clearly:
...
> Animals don't appear at all in the original dataset — making synthetic augmentation the only viable path.
...
### Performance Degradation on Standard Classes (M3 vs M2 on Test-Clean)
...
- Apartsin, S. (2024). **StableSteering: Iterative preference-guided image generation.** `ApartsinProjects/StableSteering`
